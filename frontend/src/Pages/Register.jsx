...
const Register = () => {
  ...
  const step1 = form.name.length > 0;
  const step2 = form.email.length > 0;
  const step3 = form.password.length > 0;
          ...
          <div className="col-lg-4 d-none d-lg-flex flex-column align-items-center">
            <motion.div {...fadeUp(0.2)} style={{ textAlign: "center" }}>
              ...
              <p style={{ fontSize: ".85rem", color: muted, lineHeight: 1.7 }}>
                Create an account to write blogs, connect with readers, and share your ideas with the world.
              </p>
            ...
            <motion.div
              ...
              <div className="mb-4">
                ...
                <h1 className="mb-1"
                  ...
                  Create <em style={{ fontStyle: "italic", color: gold }}>Account</em> 🚀
                </h1>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <select name="role" value={form.role} onChange={handleChange}
                    ...
                    <option value="user"  style={{ background: "#041428" }}>User</option>
                    <option value="admin" style={{ background: "#041428" }}>Admin</option>
                  </select>
                </div>
                ...
                <div className="d-flex align-items-center gap-2 mb-4">
                  ...
                  <span style={{ fontSize: ".75rem", color: dimmer, letterSpacing: "1px", textTransform: "uppercase" }}>Or register with</span>
                  <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,.08)" }} />
                </div>
